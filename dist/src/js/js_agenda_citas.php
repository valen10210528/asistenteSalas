...
<script>
    ...
    var KTAppCalendar = function() {
        ...
        const q = e => {
            ...
            N = () => {
                f.innerText = "Generar Cita", v.show();
                n.value = "";
                a.value = "";
                ...
                prueba = _.addEventListener("click", (function(t) {
                    ...
                    y && y.validate().then((function(t) {
                        if ("Valid" == t) {
                            ...
                            fetch('src/ajax/a_agenda_citas.php', {
                            ...
                            Swal.fire({
                                text: "Para generar la cita, debes de llenar los campos requeridos!!!",
                                icon: "error",
                                buttonsStyling: !1,
                                ...
                                fetch('src/ajax/a_agenda_citas.php', {
                                    ...
                                    .then(data => {
                                        ...
                                        if (data.resultado == "ok") {
                                            ...
                                            setTimeout((function() {
                                                _.removeAttribute("data-kt-indicator"), Swal.fire({
                                                    text: "¡Cita generada!! La cita se ha generado exitosamente",
                                                    icon: "success",
                                                    buttonsStyling: !1,
                                                    confirmButtonText: "Ok, got it!",
                                                    customClass: {

...
<div class="header-mobile py-3" style="background-color: #2275A4;" >
	<!--begin::Container-->
	<div class="container d-flex flex-stack">
		<!--begin::Mobile logo-->
		<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
			<a href="" target="_blank">
				<img alt="Logo" src="assets/media/logos/LogoAsisSalas.png" class="h-35px" />
...
<!--begin::Header-->
<div id="kt_header" data-step="6" data-intro="En la Barra de Herramientas tendremos acceso a aplicaciones y notificaciones rapidas en cualquier momento" style="background-color: #2275A4" class="header py-6 py-lg-0" data-kt-sticky="true" data-kt-sticky-name="header" data-kt-sticky-offset="{lg: '300px'}" >
	<!--begin::Container-->
